...
def main(sysargv):
	...
	repertoire = getRepertoire(UKF_filt, './figures/'+modelString+'_UKFilt/R0Est_TS/sexe_'+str(sexe)+'_delay_'+str(TS), './figures/'+modelString+'/R0Est_TS/sexe_'+str(sexe)+'_delay_'+str(TS))
