...
def main(sysargv):
	...
	"""
		...
		>> python3 MapDptR0.py R0Moyen_11_12.csv               # default values : SEIR1R2, 0, 1
		>> python3 MapDptR0.py R0Moyen_11_12.csv SEIR1R2D 1 2 
	...
	for p in range(3):
		...
		minRO = df[labelRO].min()
		maxRO = df[labelRO].max()
		if verbose>0:
			print('minRO=', minRO)
			print('maxRO=', maxRO)
